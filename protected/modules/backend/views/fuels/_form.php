...
<?php $form=$this->beginWidget('BsActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <?php echo $form->textFieldControlGroup($model,'calorific',array('size'=>25,'maxlength'=>25)); ?>
        <?php echo $form->textFieldControlGroup($model,'units',array('size'=>25,'maxlength'=>25)); ?>
        <?php echo $form->textFieldControlGroup($model,'price',array('size'=>25,'maxlength'=>25)); ?>
        <?php echo $form->textFieldControlGroup($model,'priceComment',array('size'=>255,'maxlength'=>255)); ?>
        <?php echo $form->checkBoxControlGroup($model,'priceFor1000'); ?>
        <?php echo $form->textFieldControlGroup($model,'translate'); ?>
